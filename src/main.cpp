...
uint256 hashGenesisBlock("0x63e13ae0694a8e4928f26ccc7086cf32c882e8f2bef70f944ac5e0b553a0afb0");
...
const string strMessageMagic = "copyclonecoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60; // copyclonecoin: 1 hour
static const int64 nTargetSpacing = 45; // copyclonecoin: 45 seconds blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal copyclonecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "copyclonecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("f636ae1e49e0924e67ea26fd069701245d0305ad59bf28ae8ef7c4357f392c02");
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "20 april 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1398181772; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1372648;

        if (fTestNet)
        {
            block.nTime    = 1398014698;
            block.nNonce   = 737437;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x91efcff3daa76238adb0518c640ea4da20cf3f6aa3429ce42069757a3515c524"));
